...
const GenerateProgramPage = () => {
  ...
  useEffect(() => {
    ...
    console.error = function (msg, ...args) {
      if (
        msg &&
        (msg.includes("Error in VAPI") ||
          (args[0] && args[0].toString().includes("Error in VAPI")))
      ) {
        console.log("Ignoring known error: Error in VAPI");
        return; // don't pass to original handler
      }
                  ...
                  {[...Array(5)].map((_, i) => (
                    <div
                      ...
                      style={{
                        ...
                        height: isSpeaking ? `${waveHeights[i] || 40}%` : "5%",
                      }}
                    />
                  ))}
                </div>
